...
//private
        ...
        btCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    Toast.makeText(Parte1.this, "valor Incorreto", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void voltarInicio(View view) {
        Intent it = new Intent(Parte1.this, MainActivity.class);
        startActivity(it);
    }

    public void irParte2(View view) {
        Intent it = new Intent(Parte1.this, Parte2.class);
        startActivity(it);
    }
}
